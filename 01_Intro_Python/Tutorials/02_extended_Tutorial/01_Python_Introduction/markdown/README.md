...
- [Inline HTML - You can also use raw HTML in your Markdown, and it'll mostly work pretty well.](#inline-html---you-can-also-use-raw-html-in-your-markdown-and-itll-mostly-work-pretty-well)
- [Horizontal Rule](#horizontal-rule)
- [Line Breaks](#line-breaks)
- [Code](#code)
- [Email](#email)
- [Table](#table)
    - [Table - _rowspan_](#table---rowspan)
    - [Table - _colspan_](#table---colspan)
- [Image](#image)
  - [Image Align](#image-align)
    - [Image Align - Middle _(default)_](#image-align---middle-default)
